	    ...
	    {{ Form::open(['id' => 'formlogin', 'class' => 'validate' , 'autocomplete' => 'Off', 'data-dataType'=>'html']) }}
		    <div class="row">
	            ...
	            <div class="col-xs-11 col-sm-11 col-md-5 te-1 mb-3">
	            	<div class="form-group floating-label">
	              		{{ Form::select('user_id', $Users,'', ['class' => 'form-select select2','placeholder' => __('All Users'), 'id'=> 'user_id'])}}
	              		{{ Form::label('selec2label', __('Profiles Users'), ['class' => 'title selec2label'])}} 
	              	</div>  
	            </div>
	...
	<table class="dataTable table" cellspacing="0" width="100%">
		...
		<tbody>
			...
			<tr>
				...
				<td>{{$value['ip']}}</td>
				<td>{{__('menu.'.$value['name_process'])}}</td>
			</tr>
			@endforeach
		</tbody>
	</table>
