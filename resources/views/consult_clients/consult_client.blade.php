        ...
        <div class="row ocult">
            ...
            <div class="col-xs-10 col-sm-10 col-md-4 te-b mb-4">
                <div class="form-group floating-label">
                    {{ Form::number('code_client', null, ['class' => 'form-control numeric number', 'id'=> 'code_client', 'placeholder' => __('Code Client')])}}
...
<script>
    $(document).ready(function () {
        ...
        $('#search').on('click', function () {
                loadingWait()
                $.post("{{route('client_edit.search_client_edit', 1)}}", $('#frmUpdateClient').serialize(), function (response) {
                    Swal.close(); 
